...
const ConsultantManagerCountResult = () => {
    ...
    const { users, totalPages, currentPage, totalCount, totalInactive, isLoading, isError, error, refetch } = useFetchUsers(queryParams);

    const activeUser = totalCount - totalInactive
    // Handle search query
        ...
        <div className='p-6'>
            ...
            <div className="mb-4 flex justify-between gap-4">
                ...
                >
                    ...
                    <p className="text-2xl">{activeUser}</p>
                </div>
                <div
...
ConsultantManagerCountResult.propTypes = {

};


export default ConsultantManagerCountResult;
