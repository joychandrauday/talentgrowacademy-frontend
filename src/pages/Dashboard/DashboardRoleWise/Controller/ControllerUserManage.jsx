...
const ControllerUserManage = () => {
    ...
    const { users, totalCount, totalPages, currentPage, isLoading, isError, error, refetch } = useFetchUsers(queryParams);
    ...
    const assignUser = async (userID) => {
        try {
            ...
            if (result.isConfirmed) {
                await axiosPublic.patch(`/userss/${userID}`, { status: 'active' });
                Swal.fire('Activated!', 'The user has been activated.', 'success');
                refetch();
            }
        } catch (err) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                    <input
                        ...
                        onChange={(e) => setSearchInput(e.target.value)} // Update searchInput
