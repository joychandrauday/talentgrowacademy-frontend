...
const useTransactions = ({ page = 1, limit = 10, sortBy = 'timestamp', sortOrder = 'desc', type, withdraw, status, description }) => {
    ...
    const queryResult = useQuery({
        queryKey: ['transactions', page, limit, sortBy, sortOrder, type, withdraw, status, description],  // The query key includes the parameters for caching and refetching
