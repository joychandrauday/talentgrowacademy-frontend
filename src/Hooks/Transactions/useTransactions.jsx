...
const useTransactions = ({ page = 1, limit = 10, sortBy = 'timestamp', sortOrder = 'desc' }) => {
    ...
    const queryResult = useQuery({
        queryKey: ['transactions', page, limit, sortBy, sortOrder],  // The query key includes the parameters for caching and refetching
