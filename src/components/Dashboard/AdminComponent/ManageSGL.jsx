...
const ManageSGL = () => {
    ...
    const { seniorGroupLeaders, totalCount, isLoading, isError, refetch } = useSGL(queryParams);
    ...
    const handleSave = async (userId) => {
        try {
            ...
            if (confirm) {
                await axiosPublic.patch(`/sgls/${userId}`, editedUserData);
    ...
    const activateUser = async (userID) => {
        try {
            ...
            if (confirm) {
                await axiosPublic.patch(`/sgls/${userID}`, {
                    status: 'active',
                });
        ...
        try {
            ...
            if (formValues) {
                ...
                if (Object.keys(dataToSend).length > 0) {
                    await axiosPublic.patch(`/sgls/${userID}`, dataToSend);
                    refetch();
            ...
            <div className="overflow-x-auto">
                {isLoading ? (
                    ...
                    <table className="table table-zebra w-full">
                        ...
                        <tbody>
                            {seniorGroupLeaders.map((user, index) => (
