...
const ManageConsultantManager = () => {
    ...
    const { consultantManagers, totalCount, isLoading, isError, refetch } = useConsManager(queryParams);
    ...
    const handleSave = async (userId) => {
        try {
            ...
            if (confirm) {
                await axiosPublic.patch(`/consultant-managers/${userId}`, editedUserData);
    ...
    const activateUser = async (userID) => {
        try {
            ...
            if (confirm) {
                await axiosPublic.patch(`/consultant-managers/${userID}`, {
                    status: 'active',
                });
            ...
            <div className="overflow-x-auto">
                {isLoading ? (
                    ...
                    <table className="table table-zebra w-full">
                        ...
                        <tbody>
                            {consultantManagers?.map((user, index) => (
...
export default ManageConsultantManager;
