...
import useControllers from "../../../Hooks/roleFetch/useController";
...
const ManageController = () => {
    ...
    const { controllers, totalCount, isLoading, isError, refetch } = useControllers(queryParams);
    ...
    const handleSave = async (userId) => {
        try {
            ...
            if (confirm) {
                await axiosPublic.patch(`/controllers/${userId}`, editedUserData);
    ...
    const activateUser = async (userID) => {
        try {
            ...
            if (confirm) {
                await axiosPublic.patch(`/controllers/${userID}`, {
                    status: 'active',
                });
