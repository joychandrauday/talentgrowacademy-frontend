...
const ManageGLManager = () => {
    ...
    const { seniorGroupLeaderManagers, totalCount, isLoading, isError, refetch } = useSGLManager(queryParams);
    ...
    const handleSave = async (userId) => {
        try {
            ...
            if (confirm) {
                await axiosPublic.patch(`/sgl-managers/${userId}`, editedUserData);
    ...
    const activateUser = async (userID) => {
        try {
            ...
            if (confirm) {
                await axiosPublic.patch(`/sgl-managers/${userID}`, {
                    status: 'active',
                });
            ...
            <div className="overflow-x-auto">
                {isLoading ? (
                    ...
                    <table className="table table-zebra w-full">
                        ...
                        <tbody>
                            {seniorGroupLeaderManagers?.map((user, index) => (
...
export default ManageGLManager;
